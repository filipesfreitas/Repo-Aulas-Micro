    ...
    class MUDTCG_DESC_H_MSP430CONFIG_CLK_DMA implements Callback {
        ...
        public void execute() {
            try {
               ...
               oStream.newLine();
               if(crystalFrequencyValue == null){
                   oStream.write("#define USB_XT_FREQ_VALUE       " + "4.0" + "  // Indicates the freq of the crystal on the oscillator indicated by USB_PLL_XT");
                   oStream.newLine();
               }else{
                   oStream.write("#define USB_XT_FREQ_VALUE       " + crystalFrequencyValue + "  // Indicates the freq of the crystal on the oscillator indicated by USB_PLL_XT");
                   oStream.newLine();
               }
               oStream.write("#define USB_XT_FREQ       " + crystalFrequency + "  // Indicates the freq of the crystal on the oscillator indicated by USB_PLL_XT");
               oStream.newLine();
