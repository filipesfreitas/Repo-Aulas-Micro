...
public class DescriptorLoadFile {
    XMLDOM xmlDOM;
    HashMap<String,Object> descToolMap;
    
    public HashMap<String, Object> getDescToolMap() {
        return descToolMap;
    }

    public void setDescToolMap(HashMap<String, Object> descToolMap) {
    ...
    private HashMap<String,Object> extractContent(){
        this.descToolMap = new HashMap<String, Object>();
        Node mainNode;
        Node childNode;
        NodeList childNodes;
        // Extract ToolOptions
    ...
    private void extractUSBConfiguration(Node mspNode) {
        ...
        HashMap<String,Object> interfMap = new HashMap<String, Object>();
    ...
    private void extractInterface(HashMap<String, Object> interfMap, Node interf, int i) {
    ...
    private MSCInterface430 extractMSCInterface(Node interf) {
        ...
        HashMap<Integer,MSCInterface430.LogicalUnit> lunMap = 
                new HashMap<Integer,MSCInterface430.LogicalUnit>();
    ...
    private int getNumberOfEndPoints() {
        ...
        int mscIntf = 0;
        int phdcIntf = 0;
        HashMap<String,Object> intfMap =(HashMap<String,Object>)descToolMap.get("interfaces");
