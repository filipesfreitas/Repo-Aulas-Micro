...
#define LED_ANY_MODE_BIT		BIT3
#define LED_ANY_MODE_POUT		P1OUT

#define LED_EXT_FIELD_PDIR		P1DIR
#define LED_EXT_FIELD_BIT		BIT1
#define LED_EXT_FIELD_POUT		P1OUT

#define LED_RW_MODE_PDIR		P1DIR
#define LED_RW_MODE_BIT			BIT0
#define LED_RW_MODE_POUT		P1OUT

#define LED_P2P_MODE_PDIR		P8DIR
#define LED_P2P_MODE_BIT		BIT1
#define LED_P2P_MODE_POUT		P8OUT

#define LED_CE_MODE_PDIR		P8DIR
#define LED_CE_MODE_BIT			BIT2
#define LED_CE_MODE_POUT		P8OUT

#define LED_TEST_BLINK_PDIR		P1DIR
#define LED_TEST_BLINK_BIT		BIT5
#define LED_TEST_BLINK_POUT		P1OUT

#define PIN_SERIAL_TX_PDIR		P4DIR
#define PIN_SERIAL_TX_BIT		BIT3
#define PIN_SERIAL_TX_POUT		P4OUT

#define PIN_SERIAL_RX_PDIR		P4DIR
#define PIN_SERIAL_RX_BIT		BIT2
#define PIN_SERIAL_RX_POUT		P4OUT

#define PIN_EXT_FIELD_PDIR		P4DIR
#define PIN_EXT_FIELD_BIT		BIT1
