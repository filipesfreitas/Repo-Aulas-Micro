MSP-EXP430FR5969 Software Examples v1.03.01
...
The software example projects are located in the 'Source' folder:
 ...
 2. 430BOOST-SHARP96_GrlibExample_FR5969 | Grlib Example for SHARP96x96 LCD
                                            display source code
 3. OutOfBox_MSP430FR5969                | The out of box demo source code
 4. OutOfBox_MSP430FR5969_GUI            | The out of box demo GUI's source code
...
|-Firmware                                  : Folder containing example firmwares
  ...
  |-Source                                  : Example firmware source projects
    ...
    |--430BOOST-SHARP96_GrlibExample_FR5969 : Grlib Display Example source code
    |--OutOfBox_MSP430FR5969                : Out of box demo source code
    |--OutOfBox_MSP430FR5969 GUI            : Out of box demo GUI source code
