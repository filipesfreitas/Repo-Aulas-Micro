...
static void Sharp96x96_InitializeDisplayBuffer(void *pvDisplayData, uint16_t ucValue);
...
const Graphics_Display g_sharp96x96LCD =
{
	...
	Sharp96x96_InitializeDisplayBuffer //Clear screen. Contents of display buffer unmodified
};
